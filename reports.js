...
window.VQA_REPORTS = [
  ...
  },
  {
    ...
    html: `
      ...
      <div class="verdict">
        ...
        <div class="v pass"><p class="k">ERROR STYLE</p><div class="val">Resolved</div><p class="sub">Error now Bold; group error model is an open question</p></div>
      </div>
      ...
      <p><strong>Resolved (QA-CG-ERROR):</strong> retested 2026-07-30, the group error message now renders <strong>Bold</strong> (Body3 13px-B, weight 700), 13px, #b00000, matching the frame. Fixed alongside Radio Group.</p>
      ...
      <table>
        ...
        <tr><td class="id">QA-CG-ERROR</td><td>Error message weight</td><td><span class="tag pass">RESOLVED</span></td><td>Retested 2026-07-30: the group error message now renders Bold (700), 13px, #b00000 (Body3 13px-B). Fixed (shared with Radio Group).</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <h2>4. Error handling</h2>
      <p><strong>Resolved (QA-RG-ERROR):</strong> retested 2026-07-30, the group error message now renders <strong>Bold</strong> (Body3 13px-B, weight 700), 13px, #b00000, matching the frame. Fixed alongside Checkbox Group.</p>
      <div class="callout info" style="border-left-width:6px">
        <p style="margin:0 0 6px;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:var(--info)">Open question · team alignment</p>
      ...
      <table>
        ...
        <tr><td class="id">QA-RG-ERROR</td><td>Error message weight</td><td><span class="tag pass">RESOLVED</span></td><td>Retested 2026-07-30: the group error message now renders Bold (700), 13px, #b00000 (Body3 13px-B). Fixed (shared with Checkbox Group).</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <div class="verdict">
        ...
        <div class="v pass"><p class="k">INVERSE VARIANT</p><div class="val">Pass</div><p class="sub">Implemented; white states verified on dark surface</p></div>
      </div>
      ...
      <h2>5. Inverse variant (added 2026-07-29, resolved 2026-07-30)</h2>
      <p>Design added an inverse Link variant for dark surfaces (used by the Footer accordion content). Every state resolves to white; the type (Maison Neue Bold 14px) and icon-gap (8) are unchanged from the default variant. <strong>Retested 2026-07-30: implemented in the build.</strong> The new "Inverse Surface" story renders every state white on the <span class="mono">#89847f</span> band, verified: standalone, back-to-results (leading chevron), the inline link with its persistent underline, and disabled, all <span class="mono">#ffffff</span>. This resolves QA-LN-02 and unblocks the Footer's QA-FTR-CONTENT.</p>
      <table>
        <tr><th>State</th><th>Figma (inverse)</th><th>Storybook</th><th>Status</th></tr>
        <tr><td>Default</td><td><span class="chip" style="background:#ffffff"></span><span class="mono">#ffffff</span> (color/pattern/link/inverse/default)</td><td class="mono">#ffffff</td><td class="m y">✓</td></tr>
        <tr><td>Hover</td><td><span class="chip" style="background:#ffffff"></span><span class="mono">#ffffff</span> (inverse/hover)</td><td class="mono">#ffffff</td><td class="m y">✓</td></tr>
        <tr><td>Active</td><td><span class="chip" style="background:#ffffff"></span><span class="mono">#ffffff</span> (inverse/active)</td><td class="mono">#ffffff</td><td class="m y">✓</td></tr>
        <tr><td>Visited</td><td><span class="chip" style="background:#ffffff"></span><span class="mono">#ffffff</span> (inverse/visited)</td><td class="mono">#ffffff</td><td class="m y">✓</td></tr>
        <tr><td>Disabled</td><td><span class="chip" style="background:#ffffff"></span><span class="mono">#ffffff</span> (inverse/disabled)</td><td class="mono">#ffffff</td><td class="m y">✓</td></tr>
      ...
      <table>
        ...
        <tr><td class="id">QA-LN-02</td><td>Inverse variant</td><td><span class="tag pass">RESOLVED</span></td><td>Retested 2026-07-30: the "Inverse Surface" story implements the inverse variant, all states #ffffff via color/pattern/link/inverse/*, on the #89847f band (Body2 14px Bold, icon-gap 8, inline underline intact). Was a fix; now landed. Unblocks the Footer's QA-FTR-CONTENT.</td></tr>
      </table>
    `
  },
  {
  ...
  },
  {
    ...
    html: `
      ...
      <div class="verdict">
        ...
        <div class="v pass"><p class="k">ALIGNMENT</p><div class="val">Resolved</div><p class="sub">Ellipsis now level with the numbers</p></div>
      </div>
      <p><strong>Retested 2026-07-30: resolved.</strong> The ellipsis now sits level with the page numbers and the current-page underline (box centers align and the glyphs read on the row line). Tokens and accessibility remain clean, so Pagination is a full pass.</p>
      ...
      <h2>2. Alignment - Figma vs build (mid-range, resolved)</h2>
      <p>Same content. After the fix, the build matches Figma: the ellipsis is level with the numbers and arrows.</p>
      ...
      <div class="callout info">
        ...
        <strong>The ellipsis is now vertically centered.</strong> Retested 2026-07-30: the dots sit level with the numbers and the current-page underline. The figures below are kept as history of the original issue.
      </div>
      ...
      <figure style="margin:16px 0;border:1px solid var(--sh-border)">
        ...
        <figcaption style="font-size:12px;color:var(--sh-mid-gray);padding:8px 12px;background:var(--sh-light-tan-1)"><strong>Originally reported evidence, kept for history.</strong> The misalignment as first flagged; resolved at the 2026-07-30 retest.</figcaption>
      </figure>
      ...
      <table>
        ...
        <tr><td class="id">QA-PG-01</td><td>Vertical alignment</td><td><span class="tag pass">RESOLVED</span></td><td>Retested 2026-07-30: ellipsis now sits level with the numbers and the current-page underline. Was reopened after the 2026-07-28 retest; now fixed.</td></tr>
      </table>
    `
  },
  {
...
Fix approach is the team's call - no code prescribed.`
    ...
    html: `
      ...
      <div class="swatchgrid" style="grid-template-columns:170px 1fr">
        ...
        <div class="stc">Storybook build<br><span style="font-weight:400;color:#757575">(truncates to 10 + See more)</span></div><div class="cell">
          <div style="width:280px;font-size:14px;border-top:1px solid #dcdcdc">
            <div style="border-bottom:1px solid #dcdcdc"><div style="display:flex;justify-content:space-between;align-items:center;padding:20px 16px"><span style="color:#343434;font-weight:700">Size</span><span style="color:#07729c;font-weight:700">&minus;</span></div><div style="padding:0 16px 16px 16px;color:#343434">
              <div style="display:flex;align-items:center;gap:8px;padding:3px 0"><span style="width:16px;height:16px;border:1px solid #c4c4c4;display:inline-block;flex:0 0 16px"></span> 1/8" (7)</div>
              <div style="display:flex;align-items:center;gap:8px;padding:3px 0"><span style="width:16px;height:16px;border:1px solid #c4c4c4;display:inline-block;flex:0 0 16px"></span> 1/4" (46)</div>
              ...
              <div style="display:flex;align-items:center;gap:8px;padding:3px 0"><span style="width:16px;height:16px;border:1px solid #c4c4c4;display:inline-block;flex:0 0 16px"></span> 2" (109)</div>
              <div style="display:flex;align-items:center;gap:8px;padding:3px 0"><span style="width:16px;height:16px;border:1px solid #c4c4c4;display:inline-block;flex:0 0 16px"></span> 2-1/2" (37)</div>
              <div style="color:#07729c;padding-top:8px">See more</div>
            </div></div>
          </div>
        </div>
      </div>
      <p style="font-size:12px;color:#757575">Both now stop at 10 items and show a blue "See more" (with "See less" to collapse); a group of 10 or fewer shows no link. One difference remains: the build renders "See more" at regular weight while Figma shows it Bold (see the note above).</p>
...
Remaining work is wiring, not tokens: the inverse variant already ships. Fix approach is the team's call - no code prescribed.`
  ...
  },
  {
    ...
    html: `
      ...
      <p>A removable filter chip: a pill showing an active selection (for example "Category: Value") that the user can dismiss with a trailing × . The whole chip is the dismiss target. Bound to the <code>pattern/removable/*</code> tokens. Composed into the <a href="#chip-group" style="color:var(--sh-blue)">Chip Group</a> for applied-filter bars.</p>
      ...
      <div class="verdict">
        ...
        <div class="v pass"><p class="k">STATES</p><div class="val">Pass</div><p class="sub">Default + Hover; no disabled variant</p></div>
      ...
      <h2>2. Side-by-side</h2>
      <p>Chip rendered from the token values.</p>
      <div class="swatchgrid" style="grid-template-columns:150px 1fr">
        <div class="hd">Source</div><div class="hd">Rendering</div>
      ...
      <h2>3. States</h2>
      <p>State Default and Hover (no disabled variant, matching the frame doc note that a <code>removable.disabled</code> token exists but no disabled variant is built yet). Label is "Category: Value" or value-only; the value is Bold. <span class="m y">✓ Pass</span></p>
  ...
  },
  {
    ...
    statusType: 'pass',
    html: `
      <h1 class="rt">Chip Group</h1>
      <p class="rmeta">Figma usage 14472:622 / 14484:471 · Frame doc 16175:363 · Storybook /docs/display-chip-group · Captured 2026-07-30</p>
      <p>Composes the <a href="#chip" style="color:var(--sh-blue)">Chip</a> into an applied-filter bar. Chips lay out with an 8px horizontal gap and flexible (hug) width, wrap across rows, condense with a "+n More" control, and offer "Clear All". Stories: Applied Filters, With Categories.</p>

      <h2>Verdict</h2>
      <div class="verdict">
        <div class="v pass"><p class="k">LAYOUT</p><div class="val">Pass</div><p class="sub">8px gap, flexible width, wrap + "+n More"</p></div>
        <div class="v pass"><p class="k">CLEAR ALL</p><div class="val">Pass</div><p class="sub">Bulk-dismiss control present</p></div>
      </div>

      <h2>1. Layout</h2>
      <p>Chips run in a row with an 8px horizontal gap (verified in the build), flexible hug-content width, wrapping to multiple rows. When chips would overflow, a "+n More" control condenses the set and toggles to "View Less"; on mobile the row becomes horizontally scrollable. A "Clear All" control bulk-dismisses the active filters.</p>
      <span style="display:inline-flex;flex-wrap:wrap;align-items:center;gap:8px;margin:6px 0 4px">
      ...
      <p>Each chip stays an individually focusable, dismissible <code>button</code> (see the <a href="#chip" style="color:var(--sh-blue)">Chip</a> report); "Clear All" is a focusable control that removes all active filters at once.</p>

      <h2>Findings log</h2>
      <table>
        <tr><th>ID</th><th>Area</th><th>Result</th><th>Note</th></tr>
        <tr><td class="id">QA-CHIPGRP-LAYOUT</td><td>Layout</td><td><span class="tag pass">PASS</span></td><td>8px horizontal gap (verified), flexible (hug) width, wrap to rows, "+n More" / "View Less" condense-expand, mobile horizontal scroll per the usage frames.</td></tr>
        <tr><td class="id">QA-CHIPGRP-CLEAR</td><td>Clear All</td><td><span class="tag pass">PASS</span></td><td>Bulk-dismiss "Clear All" control present when filters are active.</td></tr>
      </table>
    `
  },
  {
